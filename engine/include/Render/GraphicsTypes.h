...
/*
 * This is a modified implementation of the diligent engine graphics types
 */
...
enum CPU_ACCESS_FLAGS : std::uint8_t
{
...
enum RESOURCE_DIMENSION : std::uint8_t
{
...
/// structure.
enum TEXTURE_VIEW_TYPE : std::uint8_t
{
    /// Undefined view type
...
/// structure.
enum BUFFER_VIEW_TYPE : std::uint8_t
{
    /// Undefined view type
...
///
enum TEXTURE_FORMAT : std::uint16_t
{
    /// Unknown format
...
enum TEXTURE_ADDRESS_MODE : std::uint8_t
{
    /// Unknown mode
...
enum COMPARISON_FUNCTION : std::uint8_t
{
...
enum PRIMITIVE_TOPOLOGY : std::uint8_t
{
    /// Undefined topology
...
enum MEMORY_PROPERTIES : std::uint32_t
{
...
struct DepthStencilClearValue
{
    ...
    constexpr DepthStencilClearValue(float _Depth,
                                     std::uint8_t   _Stencil) noexcept :
        Depth   {_Depth  },
        Stencil {_Stencil}
    {}
};
...
struct OptimizedClearValue
{
    ...
    void SetDepthStencil(TEXTURE_FORMAT fmt, float Depth, std::uint8_t Stencil = 0)
    {
        Format               = fmt;
...
struct DisplayModeAttribs
{
    ...
    std::uint32_t RefreshRateNumerator     = 0;

    /// Refresh rate denominator
    std::uint32_t RefreshRateDenominator   = 0;
...
enum SWAP_CHAIN_USAGE_FLAGS : std::uint32_t
{
    /// No allowed usage
...
enum SURFACE_TRANSFORM : std::uint32_t
{
...
struct SwapChainDesc
{
    ...
    std::uint8_t DefaultStencilValue           = 0;
    ...
    constexpr SwapChainDesc(std::uint32_t         _Width,
                            std::uint32_t         _Height,
                            TEXTURE_FORMAT _ColorBufferFormat,
                            TEXTURE_FORMAT _DepthBufferFormat,
                            std::uint32_t         _BufferCount         = SwapChainDesc{}.BufferCount,
                            float        _DefaultDepthValue   = SwapChainDesc{}.DefaultDepthValue,
                            std::uint8_t          _DefaultStencilValue = SwapChainDesc{}.DefaultStencilValue,
...
enum DEVICE_FEATURE_STATE : std::uint8_t
{
...
struct DeviceFeatures
{
    ...
    /// Indicates if device natively supports fence with std::uint64_t counter.
...
enum ADAPTER_VENDOR : std::uint8_t
{
...
struct Version
{
    ...
    constexpr Version(std::uint32_t _Major, std::uint32_t _Minor) noexcept :
        Major{_Major},
        Minor{_Minor}
    {
    }
...
enum WAVE_FEATURE : std::uint32_t
{
...
enum VALIDATION_LEVEL : std::uint8_t
{
...
struct TextureProperties
{
    ...
    std::uint32_t MaxTexture2DArraySlices = 0;
    ...
    std::uint32_t MaxTextureCubeDimension = 0;
...
struct BufferProperties
{
    ...
    std::uint32_t ConstantBufferOffsetAlignment = 0;
    ...
    std::uint32_t StructuredBufferOffsetAlignment = 0;
...
enum RAY_TRACING_CAP_FLAGS : std::uint8_t
{
...
struct RayTracingProperties
{
    ...
    std::uint32_t ScratchBufferAlignment   = 0;
...
enum VALIDATION_FLAGS : std::uint32_t
{
...
/// Command queue type
enum COMMAND_QUEUE_TYPE : std::uint8_t
{
...
/// Queue priority
enum QUEUE_PRIORITY : std::uint8_t
{
...
struct AdapterMemoryInfo
{
    ...
    /// are typically allocated.
    std::uint64_t  HostVisibleMemory  = 0;
    ...
    std::uint64_t  MaxMemoryAllocation = 0;
...
enum SHADING_RATE_COMBINER : std::uint8_t
{
...
enum SHADING_RATE_FORMAT : std::uint8_t
{
...
enum AXIS_SHADING_RATE : std::uint8_t
{
...
enum SHADING_RATE : std::uint8_t
{
    /// Specifies no change to the shading rate.
    SHADING_RATE_1X1 = ((AXIS_SHADING_RATE_1X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_1X),

    /// Specifies default horizontal rate and 1/2 vertical shading rate.
    SHADING_RATE_1X2 = ((AXIS_SHADING_RATE_1X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_2X),

    /// Specifies default horizontal rate and 1/4 vertical shading rate.
    SHADING_RATE_1X4 = ((AXIS_SHADING_RATE_1X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_4X),

    /// Specifies 1/2 horizontal shading rate and default vertical rate.
    SHADING_RATE_2X1 = ((AXIS_SHADING_RATE_2X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_1X),

    /// Specifies 1/2 horizontal and 1/2 vertical shading rate.
    SHADING_RATE_2X2 = ((AXIS_SHADING_RATE_2X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_2X),

    /// Specifies 1/2 horizontal and 1/4 vertical shading rate.
    SHADING_RATE_2X4 = ((AXIS_SHADING_RATE_2X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_4X),

    /// Specifies 1/4 horizontal and default vertical rate.
    SHADING_RATE_4X1 = ((AXIS_SHADING_RATE_4X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_1X),

    /// Specifies 1/4 horizontal and 1/2 vertical rate.
    SHADING_RATE_4X2 = ((AXIS_SHADING_RATE_4X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_2X),

    /// Specifies 1/4 horizontal and 1/4 vertical shading rate.
    SHADING_RATE_4X4 = ((AXIS_SHADING_RATE_4X << BLAINN_SHADING_RATE_X_SHIFT) | AXIS_SHADING_RATE_4X),
...
struct ShadingRateMode
{
    ...
    bool HasSampleCount(std::uint32_t SampleCount) const
    {
...
enum SHADING_RATE_CAP_FLAGS : std::uint16_t
{
...
enum SHADING_RATE_TEXTURE_ACCESS : std::uint8_t
{
...
struct ShadingRateProperties
{
    ...
    ShadingRateMode        ShadingRates [BLAINN_MAX_SHADING_RATES]  = {};
...
enum DRAW_COMMAND_CAP_FLAGS : std::uint16_t
{
...
enum SPARSE_RESOURCE_CAP_FLAGS : std::uint32_t
{
...
struct SparseResourceProperties
{
    ...
    std::uint32_t StandardBlockSize = 0;
...
struct CommandQueueInfo
{
    ...
    std::uint32_t             MaxDeviceContexts   = 0;
    ...
    std::uint32_t  TextureCopyGranularity[3] = {};
...
struct EngineCreateInfo
{
    ...
    std::int32_t                    EngineAPIVersion       = 0;//DILIGENT_API_VERSION;
    ...
    std::uint32_t                   AdapterId              = 0;//DEFAULT_ADAPTER_ID;
    ...
    std::uint32_t                   NumImmediateContexts   = 0;
    ...
    std::uint32_t                   NumDeferredContexts    = 0;
    ...
    /// function.
    std::uint32_t NumAsyncShaderCompilationThreads = 0xFFFFFFFFu;
    ...
    void SetValidationLevel(VALIDATION_LEVEL Level)
    {
        ...
        ValidationFlags = VALIDATION_FLAGS::VALIDATION_FLAG_NONE;
        if (Level >= VALIDATION_LEVEL::VALIDATION_LEVEL_1)
        {
            ValidationFlags |= VALIDATION_FLAGS::VALIDATION_FLAG_CHECK_SHADER_BUFFER_SIZE;
        }
    }
};
...
enum WEBGL_POWER_PREFERENCE : std::uint8_t
{
...
struct WebGLContextAttribs
{
    ...
    WEBGL_POWER_PREFERENCE PowerPreference = WEBGL_POWER_PREFERENCE_DEFAULT;
};
...
enum D3D11_VALIDATION_FLAGS : std::uint32_t
{
...
enum D3D12_VALIDATION_FLAGS : std::uint32_t
{
...
struct EngineD3D12CreateInfo : public EngineCreateInfo
{
    ...
    std::uint32_t CPUDescriptorHeapAllocationSize[4]
        {
    ...
    std::uint32_t GPUDescriptorHeapSize[2]
        {
    ...
    /// exceed 2048.
    std::uint32_t GPUDescriptorHeapDynamicSize[2]
        {
            8192,  // D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV
            1024   // D3D12_DESCRIPTOR_HEAP_TYPE_SAMPLER
        }
    ...
    std::uint32_t DynamicDescriptorAllocationChunkSize[2]
        {
    ...
    std::uint32_t QueryPoolSizes[QUERY_TYPE_NUM_TYPES]
        {
            0,   // Ignored
...
struct VulkanDescriptorPoolSize
{
    ...
    std::uint32_t NumSeparateSamplerDescriptors    = 0;
    std::uint32_t NumCombinedSamplerDescriptors    = 0;
    std::uint32_t NumSampledImageDescriptors       = 0;
    std::uint32_t NumStorageImageDescriptors       = 0;
    std::uint32_t NumUniformBufferDescriptors      = 0;
    std::uint32_t NumStorageBufferDescriptors      = 0;
    std::uint32_t NumUniformTexelBufferDescriptors = 0;
    std::uint32_t NumStorageTexelBufferDescriptors = 0;
    std::uint32_t NumInputAttachmentDescriptors    = 0;
    std::uint32_t NumAccelStructDescriptors        = 0;

    constexpr VulkanDescriptorPoolSize() noexcept {}

    constexpr VulkanDescriptorPoolSize(std::uint32_t _MaxDescriptorSets,
                                       std::uint32_t _NumSeparateSamplerDescriptors,
                                       std::uint32_t _NumCombinedSamplerDescriptors,
                                       std::uint32_t _NumSampledImageDescriptors,
                                       std::uint32_t _NumStorageImageDescriptors,
                                       std::uint32_t _NumUniformBufferDescriptors,
                                       std::uint32_t _NumStorageBufferDescriptors,
                                       std::uint32_t _NumUniformTexelBufferDescriptors,
                                       std::uint32_t _NumStorageTexelBufferDescriptors,
                                       std::uint32_t _NumInputAttachmentDescriptors,
                                       std::uint32_t _NumAccelStructDescriptors)noexcept :
...
struct EngineVkCreateInfo : public EngineCreateInfo
{
    ...
    std::uint32_t             IgnoreDebugMessageCount  = 0;
    ...
    std::uint32_t DeviceLocalMemoryReserveSize     = 256 << 20;

    /// Amount of host-visible memory reserved by the engine.

    /// The engine does not pre-allocate the memory, but rather keeps free
    /// pages when resources are released.
    std::uint32_t HostVisibleMemoryReserveSize     = 256 << 20;
    ...
    ///
    std::uint32_t UploadHeapPageSize               = 1 << 20;
    ...
    std::uint32_t DynamicHeapSize                  = 8 << 20;
    ...
    ///   DynamicHeapPageSize.
    std::uint32_t DynamicHeapPageSize              = 256 << 10;
...
struct EngineMtlCreateInfo : public EngineCreateInfo
{
    ...
    /// resource manager and then suballocate from this chunk in a lock-free
    /// fashion. DynamicHeapPageSize defines the size of this chunk.
    std::uint32_t DynamicHeapPageSize       = 4 << 20;
...
struct EngineWebGPUCreateInfo : public EngineCreateInfo
{
    ...
    std::uint32_t UploadHeapPageSize  = 8 << 20;
...
struct Box
{
    std::uint32_t MinX = 0; ///< Minimal X coordinate. Default value is 0
    std::uint32_t MaxX = 0; ///< Maximal X coordinate. Default value is 0
    std::uint32_t MinY = 0; ///< Minimal Y coordinate. Default value is 0
    std::uint32_t MaxY = 0; ///< Maximal Y coordinate. Default value is 0
    std::uint32_t MinZ = 0; ///< Minimal Z coordinate. Default value is 0
    std::uint32_t MaxZ = 1; ///< Maximal Z coordinate. Default value is 1

    constexpr Box(std::uint32_t _MinX, std::uint32_t _MaxX,
                  std::uint32_t _MinY, std::uint32_t _MaxY,
                  std::uint32_t _MinZ, std::uint32_t _MaxZ) noexcept:
        MinX {_MinX},
        MaxX {_MaxX},
        MinY {_MinY},
        MaxY {_MaxY},
    ...
    constexpr Box(std::uint32_t _MinX, std::uint32_t _MaxX,
                  std::uint32_t _MinY, std::uint32_t _MaxY) noexcept:
        Box{_MinX, _MaxX, _MinY, _MaxY, 0, 1}
    {}

    constexpr Box(std::uint32_t _MinX, std::uint32_t _MaxX) noexcept:
        Box{_MinX, _MaxX, 0, 0, 0, 1}
    {}

    Box() noexcept {}

    constexpr std::uint32_t Width()   const { return MaxX - MinX; }
    constexpr std::uint32_t Height()  const { return MaxY - MinY; }
    constexpr std::uint32_t Depth()   const { return MaxZ - MinZ; }
...
struct TextureFormatAttribs
{
    ...
    {
        return std::uint32_t{ComponentSize} * (ComponentType != COMPONENT_TYPE_COMPRESSED ? std::uint32_t{NumComponents} : std::uint32_t{1});
    }

    /// Initializes the structure
    constexpr TextureFormatAttribs(const char*           _Name,
                                   TEXTURE_FORMAT        _Format,
                                   std::uint8_t          _ComponentSize,
                                   std::uint8_t          _NumComponents,
                                   COMPONENT_TYPE        _ComponentType,
                                   bool                  _IsTypeless,
                                   std::uint8_t          _BlockWidth,
                                   std::uint8_t          _BlockHeight) noexcept :
        Name         {_Name         },
        Format       {_Format       },
...
enum RESOURCE_DIMENSION_SUPPORT : std::uint32_t
{
...
enum SPARSE_TEXTURE_FLAGS : std::uint8_t
{
...
enum PIPELINE_STAGE_FLAGS : std::uint32_t
{
    /// Undefined stage
...
enum ACCESS_FLAGS : std::uint32_t
{
    /// No access
...
enum RESOURCE_STATE : std::uint32_t
{
...
enum STATE_TRANSITION_TYPE : std::uint8_t
{
