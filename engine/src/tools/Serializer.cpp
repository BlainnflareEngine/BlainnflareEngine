...
namespace Blainn
{
void Serializer::CreatePrefab(Entity &entity, const Path &relativePath)
{
    YAML::Emitter out;
    ...
    BF_DEBUG("Created prefab {}", relativePath.string());
}
...
void Serializer::Transform(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Relationship(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Scripting(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::AIController(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Mesh(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Physics(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Camera(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Skybox(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::NavMeshVolume(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::ExistingNavMeshData(const Path &absolutePath, YAML::Emitter &out)
{
...
void Serializer::Perception(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::Stimulus(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::DirectionalLight(Entity &entity, YAML::Emitter &out)
{
    auto light = entity.TryGetComponent<DirectionalLightComponent>();
    if (!light) return;
...
void Serializer::PointLight(Entity &entity, YAML::Emitter &out)
{
...
void Serializer::SpotLight(Entity &entity, YAML::Emitter &out)
{
