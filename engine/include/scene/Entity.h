...
#pragma endregion
    ...
    eastl::string& Name() { return HasComponent<TagComponent>() ? GetComponent<TagComponent>().Tag : s_NoName; }
    const eastl::string& Name() const { return HasComponent<TagComponent>() ? GetComponent<TagComponent>().Tag : s_NoName; }
...
#pragma region Hierarchy functions
    ...
    eastl::vector<uuid>& Children() { return GetComponent<RelationshipComponent>().Children;  }
    const eastl::vector<uuid>& Children() const { return GetComponent<RelationshipComponent>().Children;  }
